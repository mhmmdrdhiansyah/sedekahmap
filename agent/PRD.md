...
PostgreSQL (v16.x) + PostGIS (v3.6): Database relasional utama. Ekstensi PostGIS wajib diaktifkan dari awal untuk mendukung query geospasial (pencarian radius dan bounding box skala nasional).
